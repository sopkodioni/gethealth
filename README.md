...
<div id="page-myVisits">
    ...
    <span>
        ...
        <ul>
            ...
            <li>при натисканні на іконку видалення запис видаляється зі списку</li>
        </ul> 
    </span>
</div><br><br>
...
<ul>
    ...
    <li>Розробники:
        <ul>
            <li>Александр Клевцов</li>
            <li>Денис Сопко</li>
            <li>WhatIsLove Філіппов</li>
            <li>Алексей Журавський</li>
            <li>Кирило Кухта</li>
            <li>Анастасія Москальова</li>
            <li>Антон Войченко</li>
        </ul>
    </li>
